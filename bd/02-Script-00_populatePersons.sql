...
INSERT INTO usuario(ID_USU
    , RUT_USU, NOM_USU, APP_USU, APM_USU, FNACIMIENTO_USU, EMAIL_USU, CELULAR_USU, CONTRASENA_USU, COMUNA_ID_COMUNA, TIPO_USUARIO_ID_TIPO)
select rowNum
    , to_char(trunc(dbms_random.value(8, 19) * 1000000)) ||'-'|| to_char(trunc(dbms_random.value(0, 9)))  as rut
    , t1.NOM_USU
    , t2.APP_USU
    , t3.APM_USU
    , TO_DATE(TRUNC(DBMS_RANDOM.VALUE (2429630 , 2451545)),'J') as Bdate
    ,(SUBSTR(t1.NOM_USU, 1, 1) || SUBSTR(t2.APP_USU, 1, 2) || SUBSTR(t3.APM_USU, 1, 5) || '@mail.test') as mail
    , ('+56' || to_char(trunc(dbms_random.value(2, 9) * 100000000))) as phone
    , 'a' as contra
